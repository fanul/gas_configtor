  ...
  <section class="glass-panel rounded-2xl p-6 space-y-5">
    <div class="flex flex-wrap items-center justify-between gap-3">
      <div>
        ...
        <p class="text-xs font-medium text-slate-500 mt-0.5">Kelola akun Cloudflare. Setiap akun menyimpan API Token & Account ID terpisah di Script Properties.</p>
      </div>
      <span class="text-xs font-bold px-3 py-1 rounded-full bg-slate-200/80 text-slate-700">
        {{ cf.accounts.length }} Akun Tersimpan
      </span>
    </div>
